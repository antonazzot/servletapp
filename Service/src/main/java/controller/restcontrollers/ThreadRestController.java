...
public class ThreadRestController {
    ...
    @ResponseBody
    public ResponseEntity<Map<Integer, Mark>> markMap(@PathVariable int id,
                                                      @RequestBody Theams theams) {
    ...
    @ResponseBody
    public ResponseEntity<Optional<?>> deleteEntity(@RequestParam("id") int id,
    ...
    @ResponseBody
    public void update(@RequestParam("groupId") int groupId,
                       @RequestParam("act") String act,
                       @RequestParam("entytiIdforact") int[] entytiIdforact) {
