...
import repository.threadmodelrep.threadservices.updategroupstratagy.postgressupdatestratage.*;
        ...
        try (Connection connection = datasourse.getConnection()) {
            ...
            try {
                ...
                while (rs.next()) {
                    ...
                    Trainer trainer = RepositoryFactory.getRepository()
                    ...
                    result.put(groupId,
                            new Group()
                                    ...
                                    .withTheam(ThreadRepositoryFactory.getRepository().theamFromGroup(groupId)));
                }
    ...
    public Map<Integer, Student> getstudentsFromGroup(int groupId) {
        ...
        try (Connection connection = datasourse.getConnection()) {
            ...
            try {
                ...
                rs = ps.executeQuery();
                while (rs.next()) {
                    Student student = RepositoryFactory.getRepository()
